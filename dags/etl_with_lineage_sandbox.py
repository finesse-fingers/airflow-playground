...
default_args = {
    'owner': 'airflow modified by BK',
}
# [END default_args]

# [START instantiate_dag]
with DAG(
    'lineage_tutorial_etl_dag_sandbox',
    default_args=default_args,
    description='ETL DAG tutorial with Lineage (DF Sandbox)',
    schedule_interval=None,
    start_date=days_ago(2),
    tags=['example', 'lineage'],
) as dag:
    # [END instantiate_dag]
    # [START documentation]
    dag.doc_md = __doc__
    ...
    emit_lineage_task = DatahubEmitterOperator(
        ...
        datahub_conn_id="df_datahub_sandbox",
        mces=[
            builder.make_lineage_mce(
                upstream_urns=[
                    builder.make_dataset_urn("file", "mydb.schema.tableA"),
                    builder.make_dataset_urn("file", "mydb.schema.tableB"),
                ],
    ...
    extract_task >> transform_task >> load_task >> emit_lineage_task
